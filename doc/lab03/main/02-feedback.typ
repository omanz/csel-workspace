...
La principale difficulté rencontrée lors de ce laboratoire a été de savoir par où commencer, bien que la donnée permettait déjà une idée claire du découpage et des interfaces.

Nous avons commencé par tester l'affichage sur l'écran car un pilote basique était fourni et il est toujours motivant d'avoir un effet visuel. 

Les différents laboratoires réalisés au cours du semestre nous ont fourni des briques pour aborder les différentes composantes du système. Nous avons notamment pu réutiliser plusieurs éléments développés précédemments.
